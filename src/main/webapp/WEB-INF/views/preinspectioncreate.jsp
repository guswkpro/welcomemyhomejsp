		...
		<table class="table table-bordered">
			<tbody>
				<form method="POST" action="/addpreinspectionblueprint">
					<tr>
						<th>도면 추가</th>
						<td><input name="preinspection_encoded_imgae" id='fileselector' type="file" placeholder="이미지를 선택하세요." accept="image/*" /></td>
					</tr>
					<tr>
						<td colspan="2"><input type="button" value="취소" class="preinspectionCreate-float-right" onclick="location.href = 'http://127.0.0.1:8080/preinspection'" /> <input type="button" id="btn-preinspectionblueprint" value="등록" class="preinspectionCreate-float-right" /></td>
					</tr>
				</form>
			</tbody>
		</table>
