	...
	<div class="container" style="width: 50%; height: 100%; margin-top: 5%">
		...
		<div style="width: 100%; height: 30px;">
			<button class="btn btn-secondary btn-sm" style="float: right;"
				onclick="location.href = 'http://13.124.196.226:3000/communityposting'">작성</button>
		</div>
		...
		<div>
			<c:forEach items="${CommunityList}" var="community">
				...
				<div class="row"
					style="width: 100%; height: 150px; margin: 0px 0px 20px 0px; border-radius: 5px; box-shadow: 0px 0px 3px #000; border: 1px solid black;">
					<div class="community_post_img_div"
						style="width: 25%; height: 100%;">
						<a href="/communitydetail"> <img class="community_post_img"
							style="width: 100%; height: 100%; border: 4px;" src="" alt="">
						</a>
					</div>
					<div class="posting_content"
						style="width: 75%; height: 100%; padding: 10px 20px 0px 20px; border-left: 0.2px solid gray;">
						<div>
						...
						<div class="hit-like-post" style="padding-top: 20px">
							<table style="width: 100%;">
								<tr>
									<td style="width: 10%;"><span><i
											class="fa fa-heart" style="color: red;"></i></span>${community.community_like_count}</td>
									<td style="width: 10%;"><span><i
											class="fa fa-comment"></i></span>
										${community.community_comment_count}</td>
									<td style="width: 10%;"><span><i class="fa fa-eye"></i>
									</span>${community.community_hit_count}</td>
									<td align="right"><span><i class="fa fa-calendar"></i>
									</span> ${community.community_post_date}</td>
								</tr>
							</table>
						</div>
					</div>
