...
<body>
			...
			<tbody>
				<form>
					...
					<tr>
						...
						<td>
							<div>
								<img width="500" height="300" src="public/누수.JPG" alt="이미지 없음"><br /> <img width="500" height="300" src="public/금.JPG" alt="이미지 없음"><br />
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div>
								요청하신 인테리어 요소에 관한 정보입니다.<br> 최대한 고객님의 취향에 맞는 것으로 준비하였습니다.<br> <br> 의자 <br> 가격 : 5~7만,<br> 제작 시간 : 2일,<br> <br> 침대<br> 가격 : 30~40만,<br> 제작 시간 : 7~8일,<br> <br> 도벽<br> 가격 : 100~150만,<br> 소요 시간 : 한 달 ~ 세 달 <br>
							</div>
						</td>
					</tr>
				</form>
	...
	<nav class="navbar navbar-expand-lg nav">
		...
		<div class="div_login">
			<form>
				<button class="btn btn-secondary my-sm-0 nav-button-mypage" onclick="location.href = 'http://127.0.0.1:8080/mypage'" type="button">마이페이지</button>
				<button class="btn btn-secondary my-sm-0 nav-button-logout" onclick="location.href = 'http://127.0.0.1:8080/'" type="button">로그아웃</button>
			</form>
		</div>
	</nav>
</body>
