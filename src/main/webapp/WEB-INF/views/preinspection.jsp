				...
				<table class="table table-bordered">
					<tbody>
						<form>
							<tr>
								<th>제목</th>
								<td><input type="text" placeholder="제목을 입력하세요. " class="form-control" /></td>
							</tr>
							<tr>
								<th>체크 항목</th>
								<td><label> <input type="checkbox" />누수
								</label> <label> <input type="checkbox" />금
								</label> <label> <input type="checkbox" />도벽
								</label></td>
							</tr>
							<tr>
								<th>내용</th>
								<td><textarea cols="10" rows="10" placeholder="내용을 입력하세요." class="form-control"></textarea></td>
							</tr>
							<tr>
